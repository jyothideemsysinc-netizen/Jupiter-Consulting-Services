...
export function CrossPlatformTrainingPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="bg-brand-blue-dark py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Cross Platform Training</h1>
            <p className="text-gray-300 max-w-2xl mx-auto text-lg leading-relaxed">
              Investing in the constant improvement of skills and learning new, emerging technologies.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="flex items-center gap-4 text-brand-orange">
              ...
              <h2 className="text-3xl font-bold text-brand-blue-dark">Empowering Our Employees</h2>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border-l-4 border-brand-orange relative overflow-hidden">
               <div className="absolute -right-4 -bottom-4 opacity-5">
                 <GraduationCap className="w-32 h-32 text-brand-blue-dark" />
               </div>
          ...
          >
            {[
              { title: "Continuous Learning", desc: "Access to resources that enhance existing skills and unlock new capabilities." },
              { title: "Emerging Tech", desc: "Stay ahead of the curve by training in the latest industry advancements." },
              { title: "Subsidized Costs", desc: "We invest in your future by covering the costs of essential technical training." },
              { title: "Professional Growth", desc: "Develop into a top-tier consultant with strong technical knowledge." }
            ].map((benefit, idx) => (
              <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-brand-orange/30 transition-all group">
                <div className="w-14 h-14 bg-brand-orange/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-brand-orange transition-colors">
                  <CheckCircle className="w-7 h-7 text-brand-orange group-hover:text-white transition-colors" />
                </div>
